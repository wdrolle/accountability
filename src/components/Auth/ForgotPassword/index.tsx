            ...
            <div className="hidden w-full lg:block lg:w-1/2">
              <div className="relative py-20 pl-17.5 pr-22">
                ...
                <p className="mb-5 text-white/80">
                  Let us help you get back to your CStudios messages. 
                  We'll send you instructions to reset your password.
                </p>
                <div className="relative aspect-[50/50] w-full max-w-[427px]">
                  <Image src="/images/login/forgot password.png" alt="forgot password" fill />
                </div>
              </div>
            </div>
              ...
              <div className="flex h-full flex-col justify-center py-8 pl-8 pr-8 sm:py-20 sm:pl-21 sm:pr-20">
                <div className="text-center mb-8">
                  ...
                  <p className="text-white/80">
                    ...
                    and continue receiving daily spiritual guidance.
                  </p>
                </div>
