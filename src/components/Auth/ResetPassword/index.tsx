            ...
            <div className="hidden w-full lg:block lg:w-1/2">
              <div className="relative py-20 pl-17.5 pr-22">
                ...
                <p className="mb-5 text-white/80">
                  You're almost back to receiving your CStudios messages. 
                  Set a new password to continue your spiritual journey.
                </p>
                <div className="relative aspect-[50/50] w-full max-w-[427px]">
                  <Image src="/images/login/create password.webp" alt="reset password" fill />
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              <div className="flex h-full flex-col justify-center py-8 pl-8 pr-8 sm:py-20 sm:pl-21 sm:pr-20">
                <div className="text-center mb-8">
                  <h3 className="text-2xl font-bold text-white mb-4">Reset Your Password</h3>
                  <p className="text-white/80">
                    Choose a new password to continue receiving daily inspiration from God's word.
                  </p>
                </div>
                <div>
