  ...
  return (
    <div className="flex items-center gap-4">
      <button
        ...
        className="flex w-full items-center justify-center gap-2.5 rounded-lg border border-white/[0.12] py-3 font-medium text-white duration-300 ease-in hover:bg-white/[0.12]"
      >
      <svg
        width="23"
        height="22"
