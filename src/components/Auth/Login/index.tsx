...
const login = () => {
  ...
  const loginUser = async (e: any) => {
    ...
    try {
      ...
      console.log('Attempting to Log In with:', { email: data.email, callbackUrl });
      ...
      if (response?.ok) {
        console.log('Log In successful, redirecting to:', callbackUrl);
        window.location.href = callbackUrl;
      } else {
        console.error('Log In failed but no error provided');
            ...
            <div className="flex">
              <div className="hidden w-full lg:block lg:w-1/2">
                <div className="relative py-20 pl-17.5 pr-22">
                  ...
                  <h2 className="mb-10 max-w-[500px] text-heading-4 font-bold text-white">
                    Welcome Back
                  </h2>
                  <p className="mb-5 text-white/80">
                    Continue your spiritual journey with CStudios messages that inspire and guide.
                  </p>
                  <div className="relative aspect-[50/50] w-full max-w-[427px]">
                    <Image src="/images/login/A serene sunrise.webp" alt="login" fill />
                  </div>
                </div>
              </div>
              ...
              <div className="w-full lg:w-1/2">
                <div className="py-8 pl-8 pr-8 sm:py-20 sm:pl-21 sm:pr-20">
                  <div>
                    {/* <SocialSignup /> */} {/* UNHIDE WHEN READY FOR GIT and GOOGLE login */}
                    ...
                    </span> */} {/* UNHIDE WHEN READY FOR GIT and GOOGLE login */}
                      ...
                      <form onSubmit={loginUser}>
                        <div className="relative mb-4">
                          ...
                          <input
                            ...
                            className="w-full rounded-lg border border-white/[0.12] bg-transparent py-3.5 pl-14.5 pr-4 font-medium light:text-white outline-none focus:border-purple focus-visible:shadow-none"
                          />
                        </div>
