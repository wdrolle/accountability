...
const RegisterSchema = z.object({
  name: z.string().min(1, "Full name is required")
    .regex(/^[a-zA-Z]+(?: [a-zA-Z]+)+$/, "Please enter both your first and last name"),
          ...
          <div className="flex">
            <div className="hidden w-full lg:block lg:w-1/2">
              <div className="relative py-20 pl-17.5 pr-22">
                ...
                <h2 className="mb-10 max-w-[292px] text-heading-4 font-bold text-white">
                  Begin Your Journey of CStudios
                </h2>
                <p className="mb-5 text-white/80">
                  Join our community of believers receiving daily agents verses
                  and reflections that will strengthen your faith and deepen
                  your relationship with God.
                </p>
                <div className="relative aspect-[61/50] w-full max-w-[427px]">
                  <Image src="/images/login/A serene sunrise.webp" alt="signup" fill />
                </div>
              </div>
            </div>
            ...
            <div className="w-full lg:w-1/2">
              <div className="py-8 pl-8 pr-8 sm:py-20 sm:pl-21 sm:pr-20">
                <div>
                  {/* <SocialSignup />  */} {/* UNHIDE WHEN READY FOR GIT and GOOGLE SIGNUPS */}
                  ...
                  </span> */} {/* UNHIDE WHEN READY FOR GIT and GOOGLE SIGNUPS */}
