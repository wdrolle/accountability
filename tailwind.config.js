...
module.exports = withMT({
  ...
  theme: {
    ...
    extend: {
      ...
      backgroundImage: {
        'light-gradient': 'linear-gradient(to bottom, #F5F5F5, #C0C0C0)',
        'dark-gradient': 'linear-gradient(to bottom, #030014, #100D20)',
        'light-purple-gradient': 'linear-gradient(135deg, #F0F0F0, #8646F4)',
      ...
      boxShadow: {
        ...
        light: "0px 2px 4px rgba(134, 70, 244, 0.05), 0px 6px 24px rgba(134, 70, 244, 0.15)",
        video:
